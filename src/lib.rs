...
#[derive(Debug)]
pub struct CryptoToolsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoToolsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoTools processing");
    
    let mut processor = CryptoToolsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoToolsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoToolsProcessor::new(false);
